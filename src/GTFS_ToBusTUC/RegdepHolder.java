...
public class RegdepHolder {
	...
	public ArrayList<String> dep_strings;
	...
	public RegdepHolder(String bustucOutputRootFolder) {
		...
		dep_strings = new ArrayList<String>();		// RS-2019.01.02
...
//	}	
	...
	public void writePredicates( TreeMap<String,String> tdaxIndex ){
	    ...
	    // read all departureday and change tdax 	    // store in unique ArrayList
	    ...
	    try{
			...
			outFile.write("% To Update Regcut! :-use_module( '../../../compileroute' ). :-compileroute:compile_route_set( r1611_141201 ). %findOrCreateRegcut/3\n\n");
//			compileroute:findOrCreateRegcut(r1611_141201,'db/tables/r1611_141201/regdep','db/tables/r1611_141201/regpas','db/tables/r1611_141201/regcut').

			for ( Iterator<DepDayRec> iter=dep_unique.iterator(); iter.hasNext(); ) {
				dep_strings.add( iter.next().toString() );
			}
			dep_strings.sort(null);
			for ( Iterator<String> iter=dep_strings.iterator(); iter.hasNext(); ) {
...
class DepDayRec {
	...
	public DepDayRec( String iLine, String iTour, String iDeptime, String iTdax, String iDayc ){
		line=iLine.trim();  // TA-110209 trimZero (trim whitespace before trimZeros) //RS-180812
		tour=iTour.trim();  //
