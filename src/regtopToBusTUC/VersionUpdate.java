...
public class VersionUpdate{
	...
	public static void updateVersion( String comment, String path ) throws Exception{
		...
		try { //Fix encoding
			comment = URLDecoder.decode( comment, ConvertRegTop.OUTPUT_ENCODING );
		...
		OutputStreamWriter fileWriter = new OutputStreamWriter( new FileOutputStream( file, false ), ConvertRegTop.OUTPUT_ENCODING  );
